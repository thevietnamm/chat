...
public final class Config {
	...
	public static final String LOGTAG = "EmlazeChat";

	public static final Jid BUG_REPORTS = Jid.of("soportetecnico@emlaze.co");


	public static final String DOMAIN_LOCK = null; //only allow account creation for this domain
	public static final String MAGIC_CREATE_DOMAIN = "emlazesystems.co";
